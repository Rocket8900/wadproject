...
const handleChatClick = async (instructorId) => {
  try {
    ...
    const response = await axios.post(
      `http://13.212.56.111:3001/v1/api/chat/${instructorId}`,
      null,
      {
        headers: {
...
const handleBookingClick = async (instructorId) => {
  try {
    ...
    const response = await axios.post(
      `http://13.212.56.111:3001/v1/api/booking/`,
      data,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
function InstructorCard({ instructor, showModal, onAddMarker }) {
  ...
  const fetchInstructorDP = async () => {
    try {
      ...
      const response = await axios.get(`http://13.212.56.111:3001/v1/api/S3/instructor/single/${instructor.id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const fetchSignedUrls = async () => {
    try {
      const token = Cookie.get("access_token");
      const response = await axios.get(
        `http://13.212.56.111:3001/v1/api/s3/instructor/bulk/${instructor.id}`, 
          {
            headers: {
                Authorization: `Bearer ${token}`
            },
  ...
  useEffect(() => {
    const getInstructorsData = async () => {
      try {
        ...
        const response = await axios.get(
          "http://13.212.56.111:3001/v1/api/instructor/list",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
